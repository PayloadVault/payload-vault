...
export const Button = ({
  ...
  return (
    <button
      className={`shadow-shadow-soft cursor-pointer flex w-auto items-center justify-center gap-2 whitespace-nowrap font-bold rounded-radius-md transition-colors duration-200 ease-in-out" ${
